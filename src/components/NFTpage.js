...
async function buyNFT(tokenId) {
    try {
        ...
        alert('Congrats! You successfully bought the NFT.');
        updateMessage("");
    }
    catch(e) {
            ...
            <div className="flex ml-20  pt-20 pl-20 mt-10 ">
                ...
                <div className="text-xl     bg-gray-800 ml-60 text-justify  space-y-8 text-white shadow-2xl rounded-lg border-2 border-black p-8">
                    ...
                    { currAddress != data.owner && currAddress != data.seller ?
                        <button className="enableEthereumButton text-black bg-gray-400 shadow-2xl hover:bg-blue-700 text-white font-bold py-2 px-4 rounded text-sm" onClick={() => buyNFT(tokenId)}>Buy this NFT</button>
